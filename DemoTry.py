...
def send():
	...
	d=json.loads(frontinput.decode('utf-8'))
	...
	if request.method =='POST':
		...
		# try :
			# with connection.cursor() as cursor :
				# sql="SELECT distinct id,state,type,university,score,district,website FROM cluster_table ORDER BY score DESC"
				# cursor.execute(sql)
